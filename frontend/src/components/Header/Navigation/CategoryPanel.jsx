...
const CategoryPanel = (props) => {
    ...
    const DrawerList = (
        <Box sx={{ width: 250 }} role="presentation" className="categoryPanel">
            ...
            <h3 className='p-3 text-[20px] font-[500] flex items-center justify-between'>Shop by categories <IoIosClose className='curser-pointer text-[20px]' onClick={toggleDrawer(false)} /></h3>
