        ...
        <>
            ...
            <div className="flex  gap-6 p-6 bg-gray-50 text-gray-900">
                <aside className="w-1/4 p-6 bg-white shadow-lg rounded-lg">
                    ...
                    <Typography gutterBottom className="text-gray-700 font-medium">Price range</Typography>
                    <Slider
                        value={priceRange}
                        ...
                        sx={{ color: "#f97316" }}
                    />
                    <Typography gutterBottom className="text-gray-700 font-medium">Choose Brand</Typography>
                    <Select fullWidth displayEmpty className="mb-4 border-gray-300">
                        <MenuItem value="">Choose Brand</MenuItem>
                    </Select>
                    <Typography gutterBottom className="text-gray-700 font-medium">Choose Location</Typography>
                    <Select fullWidth displayEmpty className="mb-4 border-gray-300">
                        <MenuItem value="">Choose Location</MenuItem>
                    </Select>
                    <Typography gutterBottom className="text-gray-700 font-medium">Color</Typography>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-4">
                        {Object.keys(filters).map((color) => (
                            <Button
                                ...
                                onClick={() => setFilters({ ...filters, [color]: !filters[color] })}
                                sx={{ borderColor: "#f97316", color: filters[color] ? "white" : "#f97316", backgroundColor: filters[color] ? "#f97316" : "transparent" }}
                            >
                                {color.charAt(0).toUpperCase() + color.slice(1)}
                            </Button>
                        ))}
                    </div>
                    <Typography className="text-orange-500 cursor-pointer">+ Show more</Typography>
                    <Button variant="contained" fullWidth sx={{ backgroundColor: "#f97316", color: "white", marginTop: 2, fontWeight: "bold", fontSize: "1rem", padding: "10px" }}>FILTER</Button>
                    <Typography className="text-orange-500 mt-2 text-center cursor-pointer">Reset Filter</Typography>
                </aside>
