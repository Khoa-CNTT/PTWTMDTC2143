    ...
    <div className="flex flex-col lg:flex-row gap-8 p-6">
      ...
      <div className="w-full lg:w-[350px] bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="border-t pt-4">
          <p>
            Subtotal: <span className="float-right">$1,952.66</span>
          </p>
          <p>
            Shipping:{' '}
            <span className="float-right text-green-500">Free Shipping</span>
          </p>
          <p>
            Tax: <span className="float-right">$4.00</span>
          </p>
          <p className="font-bold text-lg mt-2">
            Order Total:{' '}
            <span className="float-right text-orange-500">$1,956.66</span>
          </p>
        </div>
